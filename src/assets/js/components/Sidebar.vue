	...
	<div class="side-nav" ref="sidebar">
		...
		<nav class="side-list">
			...
			<div style="height: 80px; background: #1F60C1; padding-top: 10px;">
				...
				<center>
					<img style="border: 2px solid lightgrey; padding: 2px; margin-right: 7px; height: 55px; width: 55px; border-radius: 50%; background: #E9E8E8;" src="/static/img/prof.jpg" class="user-image" alt="User Image"/>
				</center>
			...
			<ul v-for="item in linkList">
				...
				<ul v-if="loggedinUser.is_admin" v-for="adminlinks in forAdmin">
					<li :class="{ active: adminlinks.active }">

						<a :href="adminlinks.link" @click="changeActive(adminlinks.title)">
