	...
	<div>
		...
		<div class="widget">
			<div class="chart">
				...
				<div class="container" style="padding: 3px !important; margin: 5px;">
					<div class="row">
						<div class="col-xs-3">
							<div class="well">
								
								<h3 class="well-center boldered" style="background: #FFFFFF;"> 11 <i class="fa fa-server"></i></h3>
								<h3 class="text-muted">Active Blades</h3>
								
							</div>
						</div>

						<div class="col-xs-9">
							<h2 class="sub-header">UCS FAULTS</h2>
							...
							<div class="table-responsive">
								...
								<h2 class="sub-header">Critical</h2>
								<div class="table-responsive">
									<table class="table">
										<thead>
											<tr><td>Major</td>
